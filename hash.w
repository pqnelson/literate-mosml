     ...
     value obj, count, limit;
{
  ...
  /* The \AM\ has two purposes: ensure that the return value is positive
...
static void hash_aux(value obj)
{
  ...
  /* Otherwise, |obj| is a pointer outside the heap, to an object with
     \textit{a priori} unknown structure. Use its physical address as hash key. */
  Combine((long) obj);
}
