...
\item{0.} The free block has the desired size.  Detach the block from the
      free-list and return it.
\item{1.} The free block is 1 word longer than the desired size.  Detach
...
\item{2.} The free block is big enough.  Split it in two and return the right
      block.
