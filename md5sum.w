...
{\advance\leftskip2pc\advance\rightskip2pc
...
@ Encodes input (|my_uint|) into output (|byte|). Assumes |len| is a
multiple of 4.
...
@ Decodes input (|byte|) into output (|my_uint|). Assumes |len| is a multiple of 4.
